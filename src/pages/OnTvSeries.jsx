...
const NextPage = () => {
setPage(page + 1)
    const urlnextpage = `https://api.themoviedb.org/3/tv/on_the_air?api_key=4888028033e53f9aa150a7b1fd5bf7ca&language=pt-BR&page=${page}`
...
useEffect(() => {
  const urlPopularMovies = `https://api.themoviedb.org/3/tv/on_the_air?api_key=4888028033e53f9aa150a7b1fd5bf7ca&language=pt-BR&page=${page}`
  ...
  return (
    <div className='Movies'>
        ...
        <h2 className='titlemovies'> Séries na TV: </h2>
          <div  className='moviegrid'>
